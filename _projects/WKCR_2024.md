...
<div class="row mb-3">
    <div class="col-12">
        <a href="/blog/2024/Week-17-WKCR" class="btn btn-primary">Week 17 Recap</a>
    </div>
</div>
</center>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/team_data/WKCR_2024_summary.json" }}">
<thead>
    <tr>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/team_data/WKCR_2024_positions.json" }}">
<thead>
    <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/WKCR_2024_weekly.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/WKCR_2024_draft.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/WKCR_2024_h2h.json" }}">
    <thead>
        <tr>
