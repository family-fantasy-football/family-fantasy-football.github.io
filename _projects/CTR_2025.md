...
<div class="row mb-3">
    <div class="col-12">
        <a href="/blog/2025/Week-1-CTR" class="btn btn-primary">Week 1 Recap</a>
    </div>
</div>
</center>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/team_data/CTR_2025_summary.json" }}">
<thead>
    <tr>
...
<table
 ...
 data-search="false"
 data-toggle="table"
 data-url="{{ "/assets/json/team_rosters/CTR_2025.json"}}">
 <thead>
   <tr>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/team_data/CTR_2025_positions.json" }}">
<thead>
    <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/CTR_2025_weekly.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/CTR_2025_draft.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/CTR_2025_h2h.json" }}">
    <thead>
        <tr>
