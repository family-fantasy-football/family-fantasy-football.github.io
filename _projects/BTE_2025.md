...
description: manager(s) - christine hamlin
permalink: /teams/BTE_2025/
img: assets/img/BTE_2025.jpg
importance: 13
category: 2025-26
...
<div class="row mb-3">
    <div class="col-12">
        <a href="/reports/2025/Week-14-BTE" class="btn btn-primary">Week 14 Recap</a>
    </div>
</div>
</center>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 30px auto; max-width: 600px;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 25px; border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.15); color: white; text-align: center;">
    ...
    <div style="font-size: 42px; font-weight: 700;">#11</div>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 25px; border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.15); color: white; text-align: center;">
    ...
    <div style="font-size: 42px; font-weight: 700;">4-10</div>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 25px; border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.15); color: white; text-align: center;">
    ...
    <div style="font-size: 42px; font-weight: 700;">1325</div>
    <div style="font-size: 16px; opacity: 0.9; margin-top: 5px;">94.7 PPG</div>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 25px; border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.15); color: white; text-align: center;">
    ...
    <div style="font-size: 42px; font-weight: 700;">1774</div>
    <div style="font-size: 16px; opacity: 0.9; margin-top: 5px;">126.7 PPG</div>
  </div>
</div>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/team_data/BTE_2025_summary.json" }}">
<thead>
    <tr>
...
<table
 ...
 data-search="false"
 data-toggle="table"
 data-url="{{ "/assets/json/team_rosters/BTE_2025.json"}}">
 <thead>
   <tr>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/team_data/BTE_2025_positions.json" }}">
<thead>
    <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/BTE_2025_weekly_eff.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/BTE_2025_draft.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/team_data/BTE_2025_h2h.json" }}">
    <thead>
        <tr>
