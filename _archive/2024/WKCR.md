---
layout: page
title: who killed charbonnet ramsey? (2024)
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/archive/2024/WKCR_2024_summary.json" }}">
<thead>
    <tr>
...
data-search="false"
data-toggle="table"
data-url="{{ "/assets/json/archive/2024/WKCR_2024_positions.json" }}">
<thead>
    <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/archive/2024/WKCR_2024_weekly_eff.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/archive/2024/WKCR_2024_draft.json" }}">
    <thead>
        <tr>
...
<table
    ...
    data-search="false"
    data-toggle="table"
    data-url="{{ "/assets/json/archive/2024/WKCR_2024_h2h.json" }}">
    <thead>
        <tr>
