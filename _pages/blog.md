...
<p class="card-text">{{ post.description }}</p>
                    ...
                    <p class="post-meta">
                      ...
                      <a href="{{ year | prepend: '/reports/' | prepend: site.baseurl}}">
      ...
      <p class="post-tags">
        <a href="{{ year | prepend: '/reports/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ tag | slugify | prepend: '/reports/tag/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ category | slugify | prepend: '/reports/category/' | prepend: site.baseurl}}">
